...
Если вы не указали данные для отправки файлов в телеграм или яндекс диск, файлы будут оставаться в папке  /Android/data/com.safelogj.dfly/files/video/
...
и не будут удаляться из папки  /Android/data/com.safelogj.dfly/files/video/ 
...
и после успешной отправки будут удаляться из папки  /Android/data/com.safelogj.dfly/files/video/ автоматически.
