...
Если вы не указали данные для отправки файлов в телеграмм или яндекс диск, файлы будут оставаться в папке  /Android/data/com.safelogj.spines/files/video/
...
Если вы указали данные для отправки файлов в чат телеграм, файлы будут отправляться автоматически при наличии любого интернета (пока не отправятся) 
